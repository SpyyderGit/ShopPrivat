...
<nav role="navigation" class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Filter by manufacture</a></li>
        </ul>
    </div>
</nav>

<form:form method="post" action="byMrResult">
    <table align="Center">
        <tr>
            <td><form:label path="mrName">Manufacture</form:label></td>
            <td><form:input path="mrName"/></td>
        <tr>
        </tr>
        <tr>
            <td colspan="2">
